...
PCA9685.prototype.moveServo = function (num, val) {
  ...
  console.log(Math.floor(Constants.MAX-(Constants.MAX)*(val/180)),Math.floor((Constants.MAX)*(val/180)));
  this.setPWM(num, Math.floor(Constants.MAX-(Constants.MAX)*(val/180)), Math.floor((Constants.MAX)*(val/180)));
};
